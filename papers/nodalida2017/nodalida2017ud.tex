...
% TODO: har vi något autentiskt exempel på detta? Annars är trädet vi har nu
% i figur 2 rätt bra, eftersom det är "nästan" projektivt och blir det om man
% byter plats på ÄTA och TITTA-PÅ
...
% TODO: har vi mer att säga om det här?
